...
export const Registrar = () => {
    ...
    const [terminosAceptados, setTerminosAceptados] = useState(false); // Estado para controlar la aceptación de términos
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTerminosAceptados(false); // Reiniciar el estado del checkbox
                        ...
                        <div className="col-span-2 mb-4">
                            <div className="flex items-center mb-4">
                                ...
                                <label className="text-white">
                                    Acepto los <Link to="/terminos" className="text-purple-500 underline">términos y condiciones</Link>
                                </label>
                            </div>
                        </div>
                        <div className="col-span-2 mb-4">
