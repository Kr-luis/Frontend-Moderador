...
const Terminos = () => {
    return (
        <div className="h-screen w-full flex justify-center items-center bg-gray-900 bg-cover bg-center p-6 overflow-hidden">
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 bg-opacity-90 p-10 rounded-lg shadow-lg w-full max-w-4xl h-full max-h-screen overflow-y-auto">
                ...
                <div className="flex justify-center mt-8">
                    <Link to="/" className="bg-purple-500 hover:bg-purple-600 text-white font-semibold py-2 px-6 rounded-lg">
