...
const IngresarModerador = () => {
    ...
    const handleSubmit = async (e) => { 
        ...
        try {
            ...
            // Redirige al dashboard del moderador o administrador
    ...
    return (
        <div className="min-h-screen w-full flex justify-center items-center bg-[url('/public/images/Moderador.png')] bg-no-repeat bg-cover bg-center">
            <div className="relative z-10 w-full flex justify-center items-center">
                <div className="bg-gray-900 bg-opacity-90 p-8 rounded-lg shadow-lg w-full max-w-3xl flex flex-col md:flex-row items-center justify-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 text-center md:text-left">
                        <h1 className="text-4xl font-bold mb-4 text-yellow-400">Bienvenido Moderador</h1>
